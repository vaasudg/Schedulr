...
export const TMDB_ENDPOINT = process.env.TMDB_ENDPOINT || 'https://api.themoviedb.org/3'
export const TMDB_API_KEY = process.env.TMDB_API_KEY || '516adf1e1567058f8ecbf30bf2eb9378'
